...
class MockInMemorySubjectRepository(InMemoryRepository[Subject, SubjectId], SubjectRepository):
    ...
    def __init__(self):
        ...
        self.subject1 = Subject.from_string_id(id_str="01-71-P")
        self.subject2 = Subject.from_string_id(id_str="01-72-V")
        # Subject from a different center
        self.subject3 = Subject.from_string_id(id_str="02-73-V")

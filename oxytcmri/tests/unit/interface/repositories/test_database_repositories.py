...
class TestDataBaseMRIExamRepository:
    ...
    def test_get_exam_for_subject(self, repository):
        ...
        # Arrange
        mri_exam = MRIExam.from_string_exam_id("01_71v_mr_170913")
        repository.save(mri_exam)

        # Act
        first_exam = repository.get_exam_for_subject(SubjectId("01-71-V"))
...
class TestDataBaseSubjectRepository:
    ...
    def test_find_subjects_by_center(self, repository: DataBaseSubjectRepository):
        ...
        subjects = [
            Subject.from_string_id("01-71-V"),
            Subject.from_string_id("01-72-P"),
            Subject.from_string_id("02-72-V"),
        ]

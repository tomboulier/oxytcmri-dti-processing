    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                5,
                "05_01V_MR_170615",
                "/data/Healthy/C05/05_01v_mr_170615",
            ),
            ...
            (
                ...
                23,
                "23-12T-MR-171217",
                "/data/Patient/C23/23-12t-mr-171217",
            ),
        ],
    )
...
class TestAddClinicalData:
    ...
    def test_excel_clinical_data_repository_import(
        ...
        test_key_value = data_frame.loc[
            data_frame["id_secondaire"] == "03-01-P", new_column_name
        ].values[0]
        assert (
            test_key_value
            == dictionary_of_additional_clinical_data[Subject(id="03-01-P")]
        )

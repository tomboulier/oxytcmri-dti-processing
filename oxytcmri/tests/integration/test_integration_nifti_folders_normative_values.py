...
class TestComputeDTINormativeValuesWithNiftiFoldersMRIExamRepository:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("01-71-V", DTIMetric.MD, StatisticsStrategies.MEAN, 2, 29, 101.6145),
            ("01-71-V", DTIMetric.MD, StatisticsStrategies.STD_DEV, 2, 29, 25.00),
            ("01-71-V", DTIMetric.MD, StatisticsStrategies.MEAN, 4, 59, 104.4757),
            ("01-73-V", DTIMetric.MD, StatisticsStrategies.MEAN, 2, 62, 115.0622),
        ]
    )

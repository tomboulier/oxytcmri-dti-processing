...
class TestComputeDTINormativeValuesWithNiftiFoldersMRIExamRepository:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (2, "01-71-V", DTIMetric.MD, StatisticsStrategies.MEAN, 29, 101.6145),
            (2, "01-71-V", DTIMetric.MD, StatisticsStrategies.STD_DEV, 29, 25.00),
            (4, "01-71-V", DTIMetric.MD, StatisticsStrategies.MEAN, 59, 104.4757),
            (2, "01-73-V", DTIMetric.MD, StatisticsStrategies.MEAN, 62, 115.0622),
        ]
    )

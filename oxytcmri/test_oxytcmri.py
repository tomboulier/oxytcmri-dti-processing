...
class TestModels:
    ...
    def test_secondary_id_subject(self):
        ...
        subject1 = Subject(id="01_72T_MR_160417", subject_type=SubjectType.test_patient, center=center1)
        assert subject1.get_secondary_id() == "01-72-T"

        center2 = Center(id=2, name="Paris")
        subject2 = Subject(id="02_71V_MR_27072015", subject_type=SubjectType.healthy_volunteer, center=center2)
        assert subject2.get_secondary_id() == "02-71-V"

        center13 = Center(id=13, name="Lyon")
        subject3 = Subject(id="13_71P_MR_250216", subject_type=SubjectType.patient, center=center13)
        assert subject3.get_secondary_id() == "13-71-P"
...
class TestAddClinicalData:
    ...
    def test_excel_clinical_data_repository_import(self,
        ...
        test_key_value = data_frame.loc[data_frame["id_secondaire"] == "03-71-P", new_column_name].values[0]
        assert test_key_value == dictionary_of_additional_clinical_data[Subject(id="03-71-P")]
